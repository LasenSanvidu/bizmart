  ...
  try {
    ...
    if (userDoc.exists) {
      ...
      setState(() {
        ...
        firstName = userData['firstName'] ?? "Unknown"; // Adjust key if needed
        lastName = userData['lastName'] ?? "Unknown"; // Adjust key if needed
        mobile = userData['mobile'] ?? "Unknown"; // Adjust key if needed
        email = userData['email'] ?? "Unknown"; // Email works, so it's likely correct
        isLoading = false;
      });
    } else {
                ...
                child: Padding(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      profileInfoCard("Full Name", "$firstName $lastName", Icons.badge),
